...
class ControladorVentas{
    ...
    static public function ctrCrearVenta(){
        ...
        if(isset($_POST["nuevoVendedor"])){
            ...
            $traesCliente=ModeloClientes::mdlMostrarClientes($tablaClientes,$item,$valor);


            $item1a="compras";
            $valor1a=array_sum($totalProductosComprados) + $traesCliente["compras"];
